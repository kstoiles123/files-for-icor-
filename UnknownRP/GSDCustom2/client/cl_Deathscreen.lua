...
Citizen.CreateThread(function()
	while true do
		...
		if inClientComa and respawnTimer <= 1 then
			DrawRect(0.51, 0.748, 0.38, 0.036, 0, 0, 0, 150, 0)
			DrawRect(0.494, 0.75, 1.125, 0.17, 0, 0, 0, 150, 0)
			DrawAdvancedText(0.605, 0.803, 0.005, 0.0028, 0.37, "Press [Enter] to respawn!", 238, 18, 32, 255, 6, 0)
		end
		if inClientComa and respawnTimer == 0 and IsControlJustPressed(1, 191) then
			respawnTimer = 0
			SpawnPlayer()
		end
	end
...
RegisterNetEvent('CyberRP:ClearDeathscreen')
AddEventHandler('CyberRP:ClearDeathscreen', function()
	inClientComa = false
	respawnTimer = 0
end)
